...
describe("resolveAssets", () => {
  ...
  // Real shape captured from parser/gemel.py against a real Meitav
  ...
  // Real shape from parser/excellence.py. securityNumber matching was
  ...
  // Real shape from parser/hapoalim_transactions.py (#37) — a
