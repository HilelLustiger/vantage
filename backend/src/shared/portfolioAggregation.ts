import type { CurrencyBreakdownLine, PortfolioLine } from "../dto/index.js";
...
export function aggregateHoldings(holdings: ConvertedHolding[], currency: string): PortfolioLine[] {
